...
<body text=#000000 bgColor="#ffffff" leftMargin=0 topMargin=4>
	...
	<div id="main">
		...
		<form name="alipayment" action=${pageContext.request.contextPath}/admin/insert1 method=post
		target="_blank">
			<div id="body1" class="show" name="divcontent">
				<dl class="content">
					...
					<dt>订单名称 ：</dt>
					<dd>
						<input id="WIDsubject" name="WIDsubject" value="${goods.gName}" readonly="readonly" />
					</dd>
					<hr class="one_line">
					<dt>付款金额 ：</dt>
					<dd>
						<input id="WIDtotal_amount" name="WIDtotal_amount" value="${goods.gPrice}" readonly="readonly"  />
					</dd>
					<hr class="one_line">
					<dt>商品描述：</dt>
					<dd>
						<input id="WIDbody" name="WIDbody" value="${goods.gId}" readonly="readonly"  />
					</dd>
					<dd>
						<input id="uid" name="uid" value="34" type="hidden">
					</dd>
					<hr class="one_line">
					<dt></dt>
					<dd id="btn-dd">
